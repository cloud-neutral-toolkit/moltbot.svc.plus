    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      ? (state.consoleUser?.isAdmin
        ? renderNodes({
          ...
          onDeviceApprove: (requestId) => approveDevicePairing(state, requestId, state.consoleUser ? { uuid: state.consoleUser.uuid, email: state.consoleUser.email } : null),
